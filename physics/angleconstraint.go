...
func (ac *AngleConstraint) SetMinAngle(v float32) *AngleConstraint    { ac.minAngle = v; return ac }
func (ac *AngleConstraint) SetMaxAngle(v float32) *AngleConstraint    { ac.maxAngle = v; return ac }
func (ac *AngleConstraint) SetRigidity(r float32) *AngleConstraint    { ac.rigidity = r; return ac }
