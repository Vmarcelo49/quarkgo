...
func NewSoftBodiesScene() *SoftBodiesScene {
	...
	sb1 := physics.NewSoftBody()
	sb1.AddMesh(physics.NewRectMesh(physics.Vec2{X: 128, Y: 128}, physics.Vec2Zero(),
		physics.Vec2{X: 6, Y: 6},
		physics.WithSprings(true), physics.WithPolygons(false), physics.WithParticleRadius(8)))
	sb1.SetPosition(physics.Vec2{X: 150, Y: 100})
	sb1.SetRigidity(0.3)
	...
	// Gridded rect (3×3)
	sb2 := physics.NewSoftBody()
	sb2.AddMesh(physics.NewRectMesh(physics.Vec2{X: 128, Y: 128}, physics.Vec2Zero(),
		physics.Vec2{X: 3, Y: 3}))
	sb2.SetPosition(physics.Vec2{X: 500, Y: 100})
	sb2.SetRigidity(0.1)
	...
	sb4 := physics.NewSoftBody()
	sb4.AddMesh(physics.NewPolygonMesh(64, 11, physics.Vec2Zero(), 2))
	sb4.SetPosition(physics.Vec2{X: 700, Y: 100})
	...
	sb5 := physics.NewSoftBody()
	sb5.AddMesh(physics.NewPolygonMesh(64, 12, physics.Vec2Zero(), 2))
	sb5.SetPosition(physics.Vec2{X: 900, Y: 150})
	sb5.SetRigidity(0.5)
	sb5.SetMass(0.5)
