...
func (s *Spring) MinimumDistanceFactor() float32 { return s.minimumDistanceFactor }

// MaximumDistanceFactor returns the max distance factor.
func (s *Spring) MaximumDistanceFactor() float32 { return s.maximumDistanceFactor }
...
func (s *Spring) SetMinimumDistanceFactor(v float32) *Spring { s.minimumDistanceFactor = v; return s }

// SetMaximumDistanceFactor sets the max distance factor.
func (s *Spring) SetMaximumDistanceFactor(v float32) *Spring { s.maximumDistanceFactor = v; return s }
