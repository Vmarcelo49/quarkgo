...
✅ **Phases 0–5 complete.** The engine supports rigid bodies, soft bodies (mass-spring + PBD), area bodies (sensors), joints, springs, angle constraints, raycasting, `.qmesh` serialization, concave polygon decomposition, spatial hashing broadphase, a platformer character controller, and optional parallel narrowphase.
