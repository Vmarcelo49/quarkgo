...
func TestConvexPartitionFromParticles(t *testing.T) {
	...
	particles := []*physics.Particle{
		physics.NewParticle(0, 0, 0.5),
		physics.NewParticle(10, 0, 0.5),
		physics.NewParticle(10, 5, 0.5),
		physics.NewParticle(5, 5, 0.5),
		physics.NewParticle(5, 10, 0.5),
		physics.NewParticle(0, 10, 0.5),
	}
