...
// Particle is the smallest building block of a physics mesh. Matches
// QParticle in qparticle.h, qparticle.cpp.
//
...
func (p *Particle) Mass() float32 { return p.mass }
...
func (p *Particle) Radius() float32 { return p.r }
...
func (p *Particle) SetMass(m float32) *Particle { p.mass = m; return p }
